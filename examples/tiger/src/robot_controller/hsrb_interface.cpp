...
YoubotInterface::YoubotInterface()
{
  ...
  vel_pub_ = nh_->advertise<geometry_msgs::Twist>("hsrb/command_velocity", 1);

  base_pose_sub_ = nh_->subscribe<nav_msgs::Odometry>("odom", 30, &YoubotInterface::base_pose_cb, this);
  laser_sub_ = nh_->subscribe<sensor_msgs::LaserScan>("hsrb/base_scan", 30, &YoubotInterface::laser_cb, this);
